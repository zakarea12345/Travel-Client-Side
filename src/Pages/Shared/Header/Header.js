                    ...
                    <Row>
                        <Navbar variant="light" collapseOnSelect expand="md">
                            ...
                            <Navbar.Collapse className='justify-content-end nav-menu'>
                                ...
                                {
                                    user.email && <Nav.Link activeStyle={activeLink} as={NavLink} to="/myBooking">My Booking List</Nav.Link>
                                }
                                {
                                    user.email && <Nav.Link activeStyle={activeLink} as={NavLink} to="/manageAllOrders">Manage All Orders</Nav.Link>
                                }
                                {
                                    user.email && <Nav.Link activeStyle={activeLink} as={NavLink} to="/addPackage">Add a new package</Nav.Link>
                                }
                            </Navbar.Collapse>
                        </Navbar>
                    </Row>
